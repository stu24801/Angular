...
export declare function zipProto<T, R>(): any;
export declare function zipProto<T, T2, R>(): any;
export declare function zipProto<T, T2, T3, R>(): any;
export declare function zipProto<T, T2, T3, T4, R>(): any;
export declare function zipProto<T, T2, T3, T4, T5, R>(): any;
export declare function zipProto<T, T2, T3, T4, T5, T6, R>(): any;
export declare function zipProto<T, T2>(): any;
export declare function zipProto<T, T2, T3>(): any;
export declare function zipProto<T, T2, T3, T4>(): any;
export declare function zipProto<T, T2, T3, T4, T5>(): any;
export declare function zipProto<T, T2, T3, T4, T5, T6>(): any;
export declare function zipProto<T, R>(): any;
export declare function zipProto<T, R>(): any;
export declare function zipProto<T, TOther, R>(): any;
/**
 * @param observables
 * @return {Observable<R>}
 * @method zip
