...
{
    var self_1 = this;
    var source = state.source, subscriber = state.subscriber, context_1 = state.context;
    ...
    if (!subject) {
        ...
        var result = tryCatch_1.tryCatch(callbackFunc).apply(context_1, args.concat(handler));
        if (result === errorObject_1.errorObject) {
