...
export declare function onErrorResumeNext<T, R>(): any;
export declare function onErrorResumeNext<T, T2, T3, R>(): any;
export declare function onErrorResumeNext<T, T2, T3, T4, R>(): any;
export declare function onErrorResumeNext<T, T2, T3, T4, T5, R>(): any;
export declare function onErrorResumeNext<T, T2, T3, T4, T5, T6, R>(): any;
export declare function onErrorResumeNext<T, R>(): any;
export declare function onErrorResumeNext<T, R>(): any;
export declare function onErrorResumeNext<T, R>(): any;
